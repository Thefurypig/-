...
### [View Live furypig &rarr;](https://huangxuan.me)  
...
```yml
# Site settings
title: furypig             # title of your website
SEOTitle: furypig          # check out docs for more detail
...
It's possible that you want the two things different. For me, my site-title is **“furypig”** but I want the title shows in search engine is **“furypig的博客 | furypig”** which is multi-language.
...
furypig is derived from [Clean Blog Jekyll Theme (MIT License)](https://github.com/BlackrockDigital/startbootstrap-clean-blog-jekyll/)
